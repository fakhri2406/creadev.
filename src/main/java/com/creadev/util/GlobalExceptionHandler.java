...
public class GlobalExceptionHandler {
    ...
    /**
     * Parameter and JSON parse errors
     */
    @ExceptionHandler(MethodArgumentTypeMismatchException.class)
    public ResponseEntity<ErrorResponse> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex) {
        Map<String, String> error = new HashMap<>();
        error.put("error", String.format("Parameter '%s' of value '%s' could not be converted to type '%s'",
    ...
    public ResponseEntity<ErrorResponse> handleMissingServletRequestParameter(MissingServletRequestParameterException ex) {
        Map<String, String> error = new HashMap<>();
        error.put("error", String.format("Missing request parameter '%s'", ex.getParameterName()));
    ...
    public ResponseEntity<ErrorResponse> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex) {
        Map<String, String> error = new HashMap<>();
        error.put("error", String.format("Request method '%s' not supported", ex.getMethod()));
